  ...
  <div class="right_col" role="main">
    <div class="">
      ...
      <div class="container-fluid">
        <a href="/tambahdivisi" class="btn btn-sm btn-primary">Tambah Data</a>
        <div class="row">
          <section class="card">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <center>
                        ...
                        <?php ;?>
                        <td>{{$div->divisi}}</td>
                        <td>{{$div->koordinator}}</td>
                        <td>{{$div->description}}</td>
                        <td><img src="images/divisi/{{ $div->foto }}" class="img-thumbnail" width="150px"/></td>
                        <td>
